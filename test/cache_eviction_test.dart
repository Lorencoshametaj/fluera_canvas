...
void main() {
  ...
  group('History capacity → onEvicted', () {
    testWidgets('image cache is evicted when delete op falls off ring buffer',
      ...
      expect(ImageNodePainter.isCached(
        'fluera-canvas://memory/img-evict-me',
      ), isTrue);
    ...
    testWidgets(
      ...
      expect(
        ImageNodePainter.isCached(
          'fluera-canvas://memory/shared-asset',
        ),
        isTrue,
