...
void main() {
  ...
  group('deleteSelection on stroke + image mix', () {
    testWidgets('removes both kinds of nodes from the canvas',
        (tester) async {
    ...
    testWidgets('onStrokesErased still fires (backward-compat) with stroke subset',
        (tester) async {
      final key = GlobalKey<FlueraCanvasState>();
